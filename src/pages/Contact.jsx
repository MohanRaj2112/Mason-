  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        ...
        console.warn('Reviews API offline, using local reviews:', err);
      }
    };
    fetchReviews();
  }, []);
...
>>>>>>> e10a3db42ed8ad8ba5257ceebb959b77dd75f7b1
    ...
    const contactPayload = {
      ...
      subject: inquiry.service || 'General Direct Inquiry',
      message: inquiry.message.trim()
    };

    try {
      // 1. Post to MongoDB Contacts API
      ...
      if (res.ok) {
        showToast('Inquiry recorded in database! Our engineers will call you within 2 hours. 📞', 'success', 5000);
      } else {
...
>>>>>>> e10a3db42ed8ad8ba5257ceebb959b77dd75f7b1
      ...
      // 2. Save locally for instantaneous render
      const stored = JSON.parse(localStorage.getItem('cp_reviews') || '[]');
      ...
      setRevText('');
      setReviewRating(5);
      showToast('Thank you for your review! Recorded in database ⭐', 'success');
    } catch (err) {
